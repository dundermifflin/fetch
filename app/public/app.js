...
angular.module('fetch', ['fetch.authorization', 'fetch.confirmation', 'fetch.selection', 'fetch.services', 'fetch.shelter', 'fetch.shelterDogs', 'ui.router', 'ui.bootstrap', 'angular-confirm', 'uiGmapgoogle-maps'])
