...
angular.module('angular-confirm', ['ui.bootstrap'])
  ...
  .value('$confirmModalDefaults', {
    template: '<div class="modal-header confirmPopup"><h3 class="modal-title">{{data.title}}</h3></div>' +
    '<div class="modal-body confirmPopup">{{data.text}}</div>' +
    '<div class="confirmPopup">{{data.test}}</div>' +
    '<div class="modal-footer confirmPopup">' +
